...
public class H2 {
	...
	public static void createTables(){
		try{
			...
			stmt.execute("CREATE TABLE IF NOT EXISTS Account_Type(Account_Type_ID INT PRIMARY KEY AUTO_INCREMENT,Account_Type_Name VARCHAR(255) NOT NULL UNIQUE, Asset BOOLEAN NOT NULL)");
