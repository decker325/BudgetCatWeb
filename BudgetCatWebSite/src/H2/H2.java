...
public class H2 {
	...
	public static void createTables(){
		try{
			...
			stmt.execute("CREATE TABLE IF NOT EXISTS User(User_ID INT PRIMARY KEY AUTO_INCREMENT,User_Name VARCHAR(255) NOT NULL UNIQUE, Password VARCHAR(255) NOT NULL, Email VARCHAR(255) NOT NULL, Last_Log_In DATETIME NOT NULL)");
